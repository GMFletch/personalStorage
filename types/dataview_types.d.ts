...
declare module 'expression/parse' {
  ...
  export function chainOpt<T>(
    base: P.Parser<T>,
    ...funcs: ((r: T) => P.Parser<T>)[]
  ): P.Parser<T>;
...
declare module 'data-import/markdown-file' {
  ...
  export function addRawInlineField(
    field: InlineField,
    output: Map<string, Literal[]>
  ): void;
  ...
  export function finalizeInlineFields(
    fields: Map<string, Literal[]>
  ): Map<string, Literal>;
  /** Copy all fields of 'source' into 'target'. */
  export function mergeFieldGroups(
    target: Map<string, Literal[]>,
    source: Map<string, Literal[]>
  ): void;
...
declare module 'data-import/persister' {
  ...
  export class LocalStorageCache {
    ...
    loadFile(
      path: string
    ): Promise<Cached<Partial<PageMetadata>> | null | undefined>;
...
declare module 'ui/render' {
  ...
  export function renderCompactMarkdown(
    markdown: string,
...
declare module 'expression/binaryop' {
  ...
  export class BinaryOpHandler {
    ...
    compare<T extends LiteralTypeOrAll>(
      type: T,
      compare: CompareImpl<LiteralReprAll<T>>
    ): BinaryOpHandler;
    ...
    static repr(
      op: BinaryOp,
      left: LiteralTypeOrAll,
      right: LiteralTypeOrAll
    ): string;
  }
  /** Configure and create a binary OP handler with the given parameters. */
  export function createBinaryOps(
    linkNormalizer: (x: string) => string
  ): BinaryOpHandler;
}
declare module 'expression/functions' {
  ...
  export class FunctionBuilder {
    ...
    add1<T extends LiteralTypeOrAll>(
      argType: T,
    ...
    add3<
      T extends LiteralTypeOrAll,
      U extends LiteralTypeOrAll,
      V extends LiteralTypeOrAll
    >(
      arg1: T,
      arg2: U,
      arg3: V,
...
declare module 'ui/markdown' {
  ...
  export function ErrorMessage({ message }: { message: string }): h.JSX.Element;
  /**
...
declare module 'ui/views/list-view' {
  ...
  export function createFixedListView(
    init: DataviewInit,
    elements: Literal[],
    sourcePath: string
  ): MarkdownRenderChild;
...
declare module 'api/inline-api' {
  ...
  export class DataviewInlineIOApi {
    ...
    csv(
      path: string,
      originFile?: string
    ): Promise<DataArray<DataObject> | undefined>;
   ...
   */
  export function asyncEvalInContext(
    script: string,
    context: any
  ): Promise<any>;
}
...
declare module 'index' {
  ...
  export type {
    ...
    SListEntry,
    STask,
  } from 'data-model/serialized/markdown';
...
declare module 'ui/views/inline-field' {
  ...
  export function replaceInlineFields(
...
declare module 'main' {
  ...
  export default class DataviewPlugin extends Plugin {
    ...
    registerPriorityMarkdownPostProcessor(
      priority: number,
      processor: (
        el: HTMLElement,
        ctx: MarkdownPostProcessorContext
...
declare module 'test/function/string.test' {
  export const check: (
    text: string
  ) => jest.JestMatchers<import('index').Literal>;
}
